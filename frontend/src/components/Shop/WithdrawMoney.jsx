...
const WithdrawMoney = () => {
  ...
  const deleteHandler = async () => {
    await axios
      ...
      .then((res) => {
        toast.success("Withdrawal account deleted successfully!");
        dispatch(loadSeller());
      });
  };

  const error = () => {
    toast.error("Withdrawal from account begins at $50!");
  };

  const withdrawHandler = async () => {
    if (withdrawAmount < 50) {
      toast.error("Note: You can only withdraw above $50!");
    }
  ...
  return (
    <div className="w-[90%] lg:w-[80%]  mt-3 h-[90vh] p-8">
            ...
            {paymentMethod ? (
              <div>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="pt-2">
                    <label>
                      Bank Holder's Name <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="text"
                      name=""
              ...
              <>
                ...
                {seller && seller?.withdrawMethod ? (
                  <div>
                    <div className="800px:flex justify-between items-center w-full">
