...
const Cart = ({ setOpenCart }) => {
  ...
  return (
    <>
      ...
      ></div>
      <div className="fixed top-0 right-0 h-screen w-[25%] bg-white flex flex-col justify-between shadow-md z-10 overflow-y-scroll scrollableContainer hide-scrollbar">
        <div>
